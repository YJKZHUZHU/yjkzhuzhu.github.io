<!--
 * @Author: 豆芽
 * @Date: 2021-04-30 17:49:28
 * @LastEditTime: 2021-08-25 16:27:51
 * @LastEditors: your name
 * @Description: In User Settings Editfo
 * @FilePath: /yjkzhuzhu.github.io/docs/js/提效.md
-->
...
Array.from({ length: 100 }, (item, index) => index + 1); // [1,2,3,4,5,6,7...100]
```
